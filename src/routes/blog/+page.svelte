  ...
  <div class="bg-ram  w-72  rounded-md">
    ...
    <div class="flex justify-between items-center p-2">
      ...
      <div class="flex">
        ...
        <a href={`/blog/${slug}`}   >   <button type="button" class="rounded-3xl font-bold inline-block px-6 py-2.5 bg-[#f6ff00] opacity-80	 text-black  text-xs leading-tight uppercase hover:bg-blue-700 focus:bg-blue-700 focus:outline-none focus:ring-0 active:bg-blue-800 transition duration-150 ease-in-out">Read </button></a>
